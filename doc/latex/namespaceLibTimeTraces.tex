\hypertarget{namespaceLibTimeTraces}{}\doxysection{Lib\+Time\+Traces Namespace Reference}
\label{namespaceLibTimeTraces}\index{LibTimeTraces@{LibTimeTraces}}
...
\item 
class \mbox{\hyperlink{classLibTimeTraces_1_1TimeTrace}{Time\+Trace}}
...
\begin{DoxyCompactItemize}
\item 
def \mbox{\hyperlink{namespaceLibTimeTraces_aee5d05ba3d6081550e432ef258ee54c5}{trace}} (frames, mask)
\begin{DoxyCompactList}\small\item\em Calculate the trace of a region given by a mask. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{namespaceLibTimeTraces_a53666d42fe4a521c4386d33de043e8bd}{create\+\_\+roi}} (fig, re\+\_\+display=False)
\begin{DoxyCompactList}\small\item\em Wrapper for the Roi\+Poly features. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{namespaceLibTimeTraces_a6c4840dcc6f1f5a29efda71cb244601a}{time\+\_\+trace\+\_\+cine}} (cin\+\_\+object, mask, t1=0, t2=10)
...
\mbox{\Hypertarget{namespaceLibTimeTraces_a53666d42fe4a521c4386d33de043e8bd}\label{namespaceLibTimeTraces_a53666d42fe4a521c4386d33de043e8bd}} 
\index{LibTimeTraces@{LibTimeTraces}!create\_roi@{create\_roi}}
\index{create\_roi@{create\_roi}!LibTimeTraces@{LibTimeTraces}}
\doxysubsubsection{\texorpdfstring{create\_roi()}{create\_roi()}}
{\footnotesize\ttfamily def Lib\+Time\+Traces.\+create\+\_\+roi (\begin{DoxyParamCaption}\item[{}]{fig,  }\item[{}]{re\+\_\+display = {\ttfamily False} }\end{DoxyParamCaption})}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{33 \textcolor{keyword}{def }\mbox{\hyperlink{namespaceLibTimeTraces_a53666d42fe4a521c4386d33de043e8bd}{create\_roi}}(fig, re\_display=False):}
...
\end{DoxyCode}
\mbox{\Hypertarget{namespaceLibTimeTraces_a6c4840dcc6f1f5a29efda71cb244601a}\label{namespaceLibTimeTraces_a6c4840dcc6f1f5a29efda71cb244601a}} 
\index{LibTimeTraces@{LibTimeTraces}!time\_trace\_cine@{time\_trace\_cine}}
\index{time\_trace\_cine@{time\_trace\_cine}!LibTimeTraces@{LibTimeTraces}}
\doxysubsubsection{\texorpdfstring{time\_trace\_cine()}{time\_trace\_cine()}}
{\footnotesize\ttfamily def Lib\+Time\+Traces.\+time\+\_\+trace\+\_\+cine (\begin{DoxyParamCaption}\item[{}]{cin\+\_\+object,  }\item[{}]{mask,  }\item[{}]{t1 = {\ttfamily 0},  }\item[{}]{t2 = {\ttfamily 10} }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
tt\+: \mbox{\hyperlink{classLibTimeTraces_1_1TimeTrace}{Time\+Trace}} object 
\end{DoxyReturn}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{57 \textcolor{keyword}{def }\mbox{\hyperlink{namespaceLibTimeTraces_a6c4840dcc6f1f5a29efda71cb244601a}{time\_trace\_cine}}(cin\_object, mask, t1=0, t2=10):}
...
\end{DoxyCode}
\mbox{\Hypertarget{namespaceLibTimeTraces_aee5d05ba3d6081550e432ef258ee54c5}\label{namespaceLibTimeTraces_aee5d05ba3d6081550e432ef258ee54c5}} 
\index{LibTimeTraces@{LibTimeTraces}!trace@{trace}}
\index{trace@{trace}!LibTimeTraces@{LibTimeTraces}}
\doxysubsubsection{\texorpdfstring{trace()}{trace()}}
{\footnotesize\ttfamily def Lib\+Time\+Traces.\+trace (\begin{DoxyParamCaption}\item[{}]{frames,  }\item[{}]{mask }\end{DoxyParamCaption})}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{10 \textcolor{keyword}{def }\mbox{\hyperlink{namespaceLibTimeTraces_aee5d05ba3d6081550e432ef258ee54c5}{trace}}(frames, mask):}
