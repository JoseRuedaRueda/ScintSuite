# ------------------------------------------------------------------------------
# This module contains the function to calculate time traces
# ------------------------------------------------------------------------------
import numpy as np
...
def trace(frames, mask):
    ...
    **trace**
    ...
    Calculate the trace of of a given region given by a mask. Given the set
    of frames, frames[px,py,number_frames] and the mask[px,py] this function
    just sum all the pixels inside the mask for all the frames
    ...
    :return: array with the sum of the pixels inside the mask
    """
