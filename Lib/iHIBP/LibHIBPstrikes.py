...
def readStrikeMapFile(filename: str, flip_y: bool = True, header: bool=True):
    """
<<<<<<< HEAD
...
>>>>>>> 39-tracking_frequencies
        ...
        fsize = getFileSize(fid, whence=sspar.SEEK_CUR)
        nMaps = fsize/mapSize
...
<<<<<<< HEAD
        ...
        self.maps = readStrikeMapFile(filename, flip_y=True)
