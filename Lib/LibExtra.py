"""
Usefull models and auxiliary functions

Here I placed routines usefull for the analysis but which in principle are not
...
def pitch_at_other_place(R0, P0, R):
    ...
    Assumpion: Magnetic moment is conserved, B goes like 1/R
    ...
    Note 2: If P0 and R0 are arrys and R is a point, the result will be an
