...
std_namelist = { 'elec_name': os.path.join(paths.ihibp_repo, 'Rb', 
                                           'elec_ionization.bam'),
                 'cx_name': os.path.join(paths.ihibp_repo, 'Rb',
                                         'cx_ionization.bam'),
                 'prm_name': os.path.join(paths.ihibp_repo, 'Rb',
                                          'prm_ionization.bam'),
                 'triangle_file': os.path.join(paths.ihibp_repo, 'head.3d'),
                 'scint_vertex_file': os.path.join(paths.ihibp_repo, 
                                                   'plate.pl'),
