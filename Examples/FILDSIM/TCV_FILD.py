...
if __name__ == '__main__':
    ...
    gyro_arrays = [[0.75, 1.0, 1.5, 2., 2.5, 3., 3.5], #For each indivudual slit, ur->ll [2.0, 4.0],#
                   [0.75, 1.0, 1.5, 2., 2.5, 3., 3.5], 
                   [0.75, 1.0, 1.5, 2., 2.5, 3., 3.5],
                   [0.75, 1.0, 1.5, 2., 2.5, 3., 3.5]]
    #pitch angle grid in [degrees]
    pitch_arrays = [[90., 85., 80., 75., 70., 55., 35., 25., 15., 5.],
    ...
    gyrophase_range = np.array([7.6,8.6]) #UL

    #gyrophase_range = np.array([10.9,11.5]) #LL
    #gyrophase_range = np.array([7.8, 8.3]) #LR
    
    gyrophase_range = np.array([9.8,12.2]) #UR
    #gyrophase_range = np.array([7.2,8.6]) #UL
